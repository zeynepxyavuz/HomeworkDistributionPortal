    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Classid = table.Column<int>(name: "Class_id", type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Classname = table.Column<string>(name: "Class_name", type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Deliveryies", x => x.DeliveryId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliveryies_HomeworkId",
                table: "Deliveryies",
                column: "HomeworkId");
